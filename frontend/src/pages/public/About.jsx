    ...
    <div className="py-5" style={{ backgroundColor: '#0b0f19' }}>
      <div className="container">
        ...
        <div className="text-center mb-5">
          <span className="text-warning small fw-bold tracking-wider uppercase glow-text">ESTABLISHED 2013</span>
          ...
          <p className="text-secondary mx-auto lead" style={{ maxWidth: '750px', fontSize: '1.1rem' }}>
            Delve into the history of The Round Table, the premium academic, literary, and MUN forum of Kirori Mal College, Delhi University.
          </p>
        </div>
        ...
        <div className="row g-5 align-items-center mb-5">
          <div className="col-lg-6">
            ...
            <p className="text-secondary" style={{ lineHeight: '1.8' }}>
              <strong>The Round Table</strong> of Kirori Mal College stands as a dynamic intellectual space committed to fostering dialogue, critical inquiry, and meaningful engagement among students. Rooted in a culture of curiosity and open exchange, the society provides a platform where ideas are not only discussed but examined, challenged, and developed through informed conversation.

            </p>
            <p className="text-secondary" style={{ lineHeight: '1.8' }}>
              Guided by the belief that learning extends beyond the classroom, The Round Table seeks to bridge academic understanding with real-world perspectives. It encourages students to engage with contemporary issues across disciplines, cultivating analytical thinking, articulate expression, and collaborative problem-solving.
          ...
          <div className="col-lg-6">
            <div className="p-4 rounded-4 glass-card border border-warning" style={{ background: 'rgba(17, 24, 39, 0.4)' }}>
              ...
              <div className="d-flex align-items-center mt-3 gap-3">
                ...
                />
                <div>
                  <h6 className="text-light mb-0 fw-bold">Dr. Prashant Shahi</h6>
                  <span className="text-warning small d-block">Faculty Convener, Kirori Mal College</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="my-5 py-3">
          ...
          <div className="timeline-container mx-auto" style={{ maxWidth: '800px' }}>
            {[
              { year: "2013", title: "The Foundation", desc: "The Round Table was chartered at Kirori Mal College by a cohort of passionate English and Political Science students." },
        ...
        <div className="mt-5 text-center">
          ...
          >
            {[
              ...
              { role: "Coordinator", name: "Samiksha", dept: "History, Year III", image: "/images/Samiksha.jpeg" },
              { role: "MUN Head", name: "Keshav Mishra", dept: "History, Year III", image: "/images/KeshavMishra.jpeg" },
              { role: "IT and Design Head", name: "Kushal Mallick", dept: "History, Year III", image: "/images/KushalMallick.jpeg" },
              { role: "Research and Development Head", name: "Ananya Bansal", dept: "History, Year III", image: "/images/AnanyaBansal.jpeg" },
              { role: "Creatives and Promotions Head", name: "Kriti Singh", dept: "History, Year III", image: "/images/KritiSingh.jpeg" },
              { role: "Marketing and Finances Head", name: "Akshat Garg", dept: "Economics, Year III", image: "/images/AkshatGarg.jpeg" },
              { role: "Event Management Head", name: "Arnav Tripathi ", dept: "English Literature, Year III", image: "/images/ArnavTripathi.jpeg" },
              { role: "Corporate handling and Content Head", name: "Akriti", dept: "History, Year III", image: "/images/Akriti.jpeg" },
            ].map((member, idx) => (
